...
export default function BlogsPage() {
  ...
  useEffect(() => {
    if (searchQuery.trim() === '') {
      const base = categoryFilter
        ? articles.filter((a) => a.category?.toUpperCase() === categoryFilter)
        : articles;
      setFilteredArticles(base);
    } else {
  ...
  }, [searchQuery, articles, categoryFilter]);
          ...
          {loading ? (
            ...
            >
              <motion.svg
                ...
                className="w-24 h-24 mx-auto text-brand-accent/30 mb-4"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
                  ...
                  {filteredArticles.map((article, index) => (
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        {article.category && (
                          <span className="text-[10px] font-bold tracking-widest text-brand-red uppercase mb-2">
                            {article.category}
                          </span>
                        )}
                        {/* Title */}
