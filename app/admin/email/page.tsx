  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8">
          ...
          <div
            className={`mb-6 p-4 rounded-lg ${
              message.type === 'success'
                ? 'bg-brand-cyan/10 border border-brand-navy/20 text-brand-navy-dark'
        ...
        <form onSubmit={handleSave}>
          <div className="space-y-6 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-navy/30 focus:border-brand-navy text-gray-900"
              />
            </div>
          ...
          <div className="flex gap-4 flex-wrap items-center">
            <button
              type="submit"
              disabled={saving}
              className="bg-brand-navy hover:bg-brand-navy-dark text-white font-semibold px-6 py-3 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="mt-8 p-4 bg-brand-cyan/10 border border-brand-navy/20 rounded-lg">
          <h3 className="font-semibold text-brand-navy-dark mb-2">How it works:</h3>
          <ul className="text-sm text-brand-navy-dark space-y-1 list-disc list-inside">
